...
public class SignupThree extends JFrame implements ActionListener {
    ...
    pindetail = new JLabel("This Is Your 4 Digit Password");
    ...
    c7 = new JCheckBox("I hearby that the above entered information details are correct to the best of my knowledge");
    ...
    if(ae.getSource() == submit){
        ...
        try{
            ...
            JOptionPane.showInputDialog(null,"Account Type is Required");
        }else {
           Conn c = new Conn();
