...
public class SignupOne extends JFrame implements ActionListener
{
    ...
    SignupOne(){
        ...
        random = Math.abs((ran.nextInt()% 90 + 10));
        ...
        JLabel personalDetails=new JLabel("page 1 : Personal Datails");
   ...
   String fname = fnameTextField.getText();
    ...
    try {
        if(name.equals("")){
            ...
            JOptionPane.showInputDialog(null,"Father's Name is Required");
        }else if(dob.equals("")){
            JOptionPane.showInputDialog(null,"Date of Birth is Required");
        }else if(email.equals("")){
            JOptionPane.showInputDialog(null,"Email Address is Required");
        }else if(address.equals("")){
            JOptionPane.showInputDialog(null,"Address is Required");
        }else if(city.equals("")){
            JOptionPane.showInputDialog(null,"city name is Required");
        }else if(state.equals("")){
            JOptionPane.showInputDialog(null,"State name is Required");
        }else if(pin.equals("")){
            JOptionPane.showInputDialog(null,"Pincode is Required");
        }else {
        Conn c = new Conn();
